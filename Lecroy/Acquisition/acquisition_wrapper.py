...
ScopeControlDir = "C:\\Users\\lgad\\Documents\\lecroy-scripts\\ScopeHandler-master\\Lecroy"

def ScopeAcquisition(numEvents):

	print ("\n ####################### Running the scope acquisition ##################################\n")
	#ScopeCommand = 'python %s\\Acquisition\\acquisition.py --runNum %s --numEvents %d --sampleRate %d --horizontalWindow %d --trigCh %s --trig %f --vScale1 %f --vScale2 %f --vScale3 %f --vScale4 %f --timeoffset %i --trigSlope %s' % (ScopeControlDir,RunNumber, NumEvents, sampleRate, horizontalWindow, trigCh, trig, vScale1, vScale2, vScale3, vScale4, timeoffset, trigSlope) 
