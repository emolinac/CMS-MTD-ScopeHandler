...
#############################################################################################################################
########################################## File modified by Esteban M. ######################################################
#############################################################################################################################

# Modifications : 4 channels instead of four, and no copy of files to wherever they were going. 
...
OutputFilePath = "C:\\Users\\lgad\\Documents\\lecroy-scripts\\ScopeHandler-master\\Lecroy\\Conversion"
...
if LocalMode:
	RawDataPath = "C:\\Users\\lgad\\Documents\\lecroy-scripts\\ScopeHandler-master\\Lecroy\\Conversion"
	RawDataLocalCopyPath = "C:\\Users\\lgad\\Documents\\lecroy-scripts\\ScopeHandler-master\\Lecroy\\Conversion"
...
inputFiles=[]
start = time.time()
# EFMC : Commenting this since it does not add anything to current execution of script
...
#	else: inputFiles.append("C%i--Trace%i.trc" % (ic+1,runNumber)) ### condor copies files to current directory
	inputFiles.append("%s\\C%i--Trace%i.trc" % (RawDataPath,ic+1,runNumber)) ### condor copies files to current directory
#
#end = time.time()
...
trigger_times,horizontal_offsets = get_segment_times(inputFiles[0],offset,nsegments)
trigger_times,horizontal_offsets2 = get_segment_times(inputFiles[1],offset,nsegments)
trigger_times,horizontal_offsets3 = get_segment_times(inputFiles[2],offset,nsegments)
trigger_times,horizontal_offsets4 = get_segment_times(inputFiles[3],offset,nsegments)
